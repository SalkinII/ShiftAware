...
const TEAM_MEMBERS = [
  // Juniors (10)
  { alias: "Bunny", avatarId: "🐰", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Otter", avatarId: "🦦", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Chipmunk", avatarId: "🐿️", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Hedgehog", avatarId: "🦔", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Squirrel", avatarId: "🐿️", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Robin", avatarId: "🐦", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Finch", avatarId: "🐦", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Duckling", avatarId: "🦆", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Fawn", avatarId: "🦌", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Kitten", avatarId: "🐱", experienceLevel: ExperienceLevel.JUNIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  
  // Intermediates (10)
  { alias: "Fox", avatarId: "🦊", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Badger", avatarId: "🦡", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Raccoon", avatarId: "🦝", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Panda", avatarId: "🐼", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Koala", avatarId: "🐨", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Owl", avatarId: "🦉", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Peacock", avatarId: "🦚", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Swan", avatarId: "🦢", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Deer", avatarId: "🦌", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER] },
  { alias: "Lynx", avatarId: "🐆", experienceLevel: ExperienceLevel.INTERMEDIATE, genderRole: "M", capabilities: [Role.TEAM_MEMBER] },
  
  // Seniors with leadership (10)
  { alias: "Wolf", avatarId: "🐺", experienceLevel: ExperienceLevel.SENIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD, Role.SUPER] },
  { alias: "Bear", avatarId: "🐻", experienceLevel: ExperienceLevel.SENIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD] },
  { alias: "Eagle", avatarId: "🦅", experienceLevel: ExperienceLevel.SENIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD, Role.SUPER] },
  { alias: "Hawk", avatarId: "🦅", experienceLevel: ExperienceLevel.SENIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD] },
  { alias: "Lion", avatarId: "🦁", experienceLevel: ExperienceLevel.SENIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD, Role.SUPER] },
  { alias: "Tiger", avatarId: "🐯", experienceLevel: ExperienceLevel.SENIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD, Role.SUPER] },
  { alias: "Falcon", avatarId: "🦅", experienceLevel: ExperienceLevel.SENIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD] },
  { alias: "Leopard", avatarId: "🐆", experienceLevel: ExperienceLevel.SENIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD] },
  { alias: "Panther", avatarId: "🐆", experienceLevel: ExperienceLevel.SENIOR, genderRole: "M", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD, Role.SUPER] },
  { alias: "Jaguar", avatarId: "🐆", experienceLevel: ExperienceLevel.SENIOR, genderRole: "FINTA", capabilities: [Role.TEAM_MEMBER, Role.SHIFT_LEAD, Role.SUPER] },
];
